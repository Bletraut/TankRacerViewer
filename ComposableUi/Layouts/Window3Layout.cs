...
{
    public sealed class Window3Layout : ContainerElement
    {
        private readonly ContainerElement _windowContainer;
        private readonly Window3Element _tempWindow;
        ...
        public void AddWindow(Window3Element window)
        {
        ...
        private void PrepareTempWindow(Window3Element source)
        {
        ...
        private void OnTabPointerDown(Window3Element window, PointerEvent pointerEvent)
        {
        ...
        private void OnTabPointerUp(Window3Element window, PointerEvent pointerEvent)
        {
            HideTempWindow();
            HideTempTab();
        }

        private void OnTabPointerDrag(Window3Element window, PointerDragEvent pointerEvent)
        {
        ...
        private void OnTabPreviewShown(Window3Element sender, Element placeHolder)
        {
        ...
        private void OnTabPreviewHidden(Window3Element sender)
        {
        ...
        private void OnSplitPreviewShown(Window3Element window)
        {
        ...
        private void OnSplitPreviewHidden(Window3Element window)
        {
